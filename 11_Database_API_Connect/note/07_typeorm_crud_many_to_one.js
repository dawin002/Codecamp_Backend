...
//          DBeaver 에서 카테고리 id 하나 복사해서 상품 등록 요청 보내기

//          상품 등록시 반환되는 객체에서 카테고리 이름은 받을 수 없음
//          이유는 카테고리 id만 save 함수 인자로 전달했기 때문에

//          1) DBeaver 에서 카테고리id 값이 없는 레코드 다 지우기
...
`
//          4) DBeaver 에 등록된 데이터 확인
//              DBeaver 을 확인하면 등록한 상품에 카테고리 id 값이 함께 저장된 것을
//              확인할 수 있음
