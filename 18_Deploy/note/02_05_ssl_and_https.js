...
//          새 HTTP(S) 부하 분산기 생성중 나오는 프론트엔드 구성과 백엔드 구성은
//          로드밸런서의 앞쪽과 뒤쪽을 지칭하는 말

//          프론트엔드 구성: 로드밸런서에서 받을 트래픽의 프로토콜과 포트번호의 설정
//          백엔드 구성: 로드밸런서에서 내보낼 트래픽의 프로토콜과 포트번호의 설정

//      리다이랙트 테스트

//          로드밸런서 세팅이 모두 끝나면 https://도메인주소/grpahql 주소로 
//          로드밸런서로 접속 가능

//          근데 http://도메인주소/graphql 주소로도 접속이 가능

//          => 리다이렉트
//          : https 사이트를 http로 접속했을 때 https로 바꿔서 접속하게 해주는 것