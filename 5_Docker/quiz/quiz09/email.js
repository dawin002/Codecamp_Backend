...
export const getWelcomeTemplate = function ({ name, phoneNumber, prefer }) {
  let phone1 = phoneNumber.substr(0, 3);
  let phone2 = phoneNumber.substr(3, 4);
  let phone3 = phoneNumber.substr(7, 4);
